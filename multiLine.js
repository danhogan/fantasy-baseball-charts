...
var drawMultiLine = function(data, chartName, categoryText, year) {
...
$(document).ready(function() {
	...
	var svg = d3.select('#container' + containerName + ' #'+ chartName + ' svg')
		.datum(data)
	...
	chart.dispatch.on('showTooltip', function(e) {
	  var offset = $('#container' + containerName + ' #'+ chartName).offset(), // { left: 0, top: 0 }
...
$(window).resize(function() {
	...
	d3.select('#container' + containerName + ' #'+ chartName + ' svg')
	  .attr('width', width(margin))
	  .attr('height', height(margin))
	  .call(chart);
});
